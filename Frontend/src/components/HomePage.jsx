...
/* ─── Inline styles object (no external CSS needed) ─── */
const S = {
  /* Navbar */
  navbar: {
    position: "absolute",
  ...
  searchBox: {
    ...
    boxShadow: "0 8px 32px rgba(0,0,0,0.5), 0 0 0 1px rgba(244,63,94,0.08)",
    transition: "border-color 0.2s, box-shadow 0.2s",
  },
  searchBoxFocused: {
    borderColor: "rgba(244,63,94,0.6)",
    boxShadow: "0 8px 32px rgba(0,0,0,0.5), 0 0 20px rgba(244,63,94,0.15)",
  },
  searchIcon: {
    fontSize: "15px",
    flexShrink: 0,
    ...
    <>
      ...
      <nav style={S.navbar}>
        ...
        <div style={{
          ...
          <span style={{
            ...
            color: "#f5f0ff", fontFamily: "'DM Sans', sans-serif",
          }}>Live Tracking</span>
        </div>
      </nav>
      ...
      <div style={S.searchWrapper}>
        <div style={{ ...S.searchBox, ...(focused ? S.searchBoxFocused : {}) }}>
          ...
          />
          {query && (
            <button className="search-clear" style={S.searchClear} onClick={clearQuery}>✕</button>
          )}
        </div>
          ...
          <div style={S.dropdown}>
            {suggestions.map((place, index) => (
              <div
                ...
                style={{
                  ...S.suggItem,
                  ...(index === suggestions.length - 1 ? S.suggItemLast : {}),
                }}
              >
